...
export default function App() {
  ...
  // Ak je výsledok k dispozícii, zobraz obrazovku s výsledkami
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F6F2", fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif" }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px" }}>
        ...
        {/* Štatistiky - skryté na obrazovke s výsledkami */}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 380px", gap: 28 }} className="fade-up">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div style={{ background: "#F7F6F2", border: "1px solid #E8E7E2", borderRadius: 16, padding: 24 }}>
                ...
                <div style={{ fontSize: 12, color: "#999" }}>Prah confidence: 0.45 · IoU: 0.50</div>
              </div>
        ...
        {/* Obrazovka detailu histórie */}
        {activeView === "history-detail" && historicalResult && (
          <div className="fade-up">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
              <div>
                <h1 style={{ fontSize: 26, fontWeight: 600, color: "#111", letterSpacing: "-.03em", marginBottom: 4 }}>Detail analýzy</h1>
                <p style={{ fontSize: 14, color: "#888" }}>
                  {historicalResult.location} - {historicalResult.date} - Nájdených {historicalResult.detections.length} dier
                </p>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 28 }}>
              <div style={{ background: "#fff", border: "1px solid #E8E7E2", borderRadius: 16, overflow: "hidden" }}>
                <div style={{ padding: "16px 20px", borderBottom: "1px solid #E8E7E2", display: "flex", justifyContent: "space-between" }}>
                  <span style={{ fontSize: 14, fontWeight: 600, color: "#111" }}>Anotovaný snímok</span>
                  <span style={{ fontSize: 12, color: "#999" }}>Uložená analýza</span>
                </div>
